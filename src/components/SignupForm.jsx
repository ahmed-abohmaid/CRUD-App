      ...
      <div className="flex flex-col mb-3">
        ...
        <div className="relative">
          <input
            ...
            className={`outline-none w-full border-2 rounded-md border-black/20 py-1 pl-3 transition-all duration-300 ease-linear focus:border-black/40 placeholder:focus:opacity-0 placeholder:focus:duration-200 placeholder:focus:ease-in ${errorsCheck(
              'password'
            )}`}
          />
          <div
